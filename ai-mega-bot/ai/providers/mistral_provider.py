"""Mistral AI Provider — all Mistral models via OpenAI-compatible API.

Mistral AI offers free "Experiment" plan with access to ALL models:
Mistral Large, Medium, Small, Codestral, Pixtral.
Rate limits: ~1 RPS, limited TPM. No credit card required.
...
class MistralProvider(BaseProvider):
    """Mistral AI provider — all models, OpenAI-compatible API."""
    ...
    async def generate(self, prompt: str, **kwargs) -> AIResponse:
        """Generate text via Mistral AI chat completions with context."""
        if not self._client:
            await self.init()
    ...
    async def translate(
        ...
        **kwargs,
        ...
        """Translate text using Mistral AI with translation system prompt."""
        lang_names = {
