"""MistralProvider — Mistral AI — all Mistral models free, OpenAI-compatible API."""
import logging
...
TEXT_MODELS = {"default": "mistral-small-latest", "fast": "mistral-small-latest", "reasoning": "mistral-medium-latest", "code": "codestral-latest"}


class MistralProvider(BaseProvider):
    """MistralProvider — OpenAI-compatible API."""
