"""ChutesProvider — Chutes AI — unlimited free API, OpenAI-compatible. No rate limits, no token caps."""
import logging
...
TEXT_MODELS = {"default": "deepseek-ai/DeepSeek-V3-0324", "fast": "Qwen/Qwen3-32B", "reasoning": "deepseek-ai/DeepSeek-R1-0528", "code": "deepseek-ai/DeepSeek-V3-0324"}


class ChutesProvider(BaseProvider):
    """ChutesProvider — OpenAI-compatible API."""
