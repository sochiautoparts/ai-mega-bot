...
class CloudflareProvider(BaseProvider):
    ...
    def is_available(self) -> bool:
        """Cloudflare requires both API token and account ID."""
    ...
    async def generate(self, prompt: str, **kwargs) -> AIResponse:
        """Generate text via Cloudflare Workers AI chat completions with context."""
        if not self._client:
            await self.init()
    ...
    async def translate(
        ...
        **kwargs,
        ...
        """Translate text using Cloudflare AI with translation system prompt."""
        lang_names = {
