"""FireworksProvider — Fireworks AI — fast inference, $1 free credits, OpenAI-compatible API."""
import logging
...
TEXT_MODELS = {"default": "accounts/fireworks/models/llama-v3p3-70b-instruct", "fast": "accounts/fireworks/models/llama-v3p1-8b-instruct", "reasoning": "accounts/fireworks/models/deepseek-v3", "code": "accounts/fireworks/models/qwen2p5-coder-32b-instruct"}


class FireworksProvider(BaseProvider):
    """FireworksProvider — OpenAI-compatible API."""
    ...
    async def generate(self, prompt: str, **kwargs) -> AIResponse:
        ...
        try:
            response = await self._client.post("/inference/v1/chat/completions", json=payload)
