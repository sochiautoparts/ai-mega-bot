"""Together AI Provider — 200+ models via OpenAI-compatible API.

Together AI provides $5 free signup credits with access to 200+ models.
Free models include DeepSeek R1, Llama 3.3, Qwen, and more.
...
class TogetherProvider(BaseProvider):
    """Together AI provider — 200+ models, OpenAI-compatible API."""
    ...
    async def generate(self, prompt: str, **kwargs) -> AIResponse:
        """Generate text via Together AI chat completions with context."""
        if not self._client:
            await self.init()
    ...
    async def translate(
        ...
        **kwargs,
        ...
        """Translate text using Together AI with translation system prompt."""
        lang_names = {
