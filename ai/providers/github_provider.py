"""GitHub Models Provider — Azure AI inference via GitHub token."""
import logging
...
class GitHubModelsProvider(BaseProvider):
    """GitHub Models provider using httpx for Azure AI inference."""
    ...
    async def generate(self, prompt: str, **kwargs) -> AIResponse:
        """Generate text via GitHub Models chat completions with conversation history."""
        if not self._client:
            await self.init()
