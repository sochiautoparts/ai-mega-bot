"""
Василий Partners — affiliate program integration (sochiautoparts.ru/partners.json).
...
logger = logging.getLogger("mega.partners")
    ...
    async def load(self):
        ...
        try:
            async with httpx.AsyncClient(timeout=15.0, follow_redirects=True) as c:
                resp = await c.get(config.PARTNERS_URL, headers={"User-Agent": "VasyaBot/1.0"})
