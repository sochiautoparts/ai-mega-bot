...
async def cmd_start(message: Message, state: FSMContext, db=None) -> None:
    ...
    welcome = (
        ...
        "💬 <b>Чат с AI</b> — общайтесь с нейросетью (с памятью контекста!)\n"
        "📷 <b>Фото</b> — отправьте фото для анализа\n"
        "🎬 <b>Видео</b> — отправьте видео для анализа\n"
        "📄 <b>Файлы</b> — отправьте файл для анализа\n"
...
async def cmd_help(message: Message) -> None:
    ...
    text = (
        ...
        "  📷 Отправьте фото — AI опишет изображение\n"
        "  🎬 Отправьте видео — AI проанализирует\n"
        "  📄 Отправьте файл — AI прочитает и проанализирует\n"
        ...
        "💡 <b>Контекст:</b> Бот помнит историю разговора!\n"
        "Используйте /clear чтобы начать сначала."
    )
...
async def cb_menu_chat(callback: CallbackQuery) -> None:
    ...
    await callback.message.edit_text(
        ...
        "🧠 <b>Контекст:</b> Бот помнит историю разговора.\n"
        "Отправляйте фото, видео, файлы — AI их проанализирует!\n\n"
        "Команды:\n"
